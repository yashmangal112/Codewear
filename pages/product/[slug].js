      ...
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-16 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img
              alt="ecommerce"
              className="lg:w-1/2 w-full lg:h-auto pl-20 pr-20 object-top rounded"
              src="https://m.media-amazon.com/images/I/81LMWWSYt4L._SY679._SX._UX._SY._UY_.jpg"
            />
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="pin mt-6 flex space-x-2 text-sm">
                <input className="px-2 border-2 border-gray-400 rounded-md" placeholder="Enter your Pincode" type="text" spellcheck="false" data-ms-editor="true"/>
